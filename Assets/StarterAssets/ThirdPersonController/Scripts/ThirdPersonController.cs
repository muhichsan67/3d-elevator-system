...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        // --- VARIABEL BARU AGAR ANIMASI TIDAK MELAYANG ---
        [HideInInspector] public bool IsOnMovingLift = false;
        ...
        private void Update()
        {
            ...
            // JIKA DI ATAS LIFT: Paksa status grounded aktif agar animasi melayang mati
            if (IsOnMovingLift)
            {
                Grounded = true;
        ...
        private void GroundedCheck()
        {
            ...
            if (IsOnMovingLift) Grounded = true;
        ...
        {
            if (animationEvent.animatorClipInfo.weight > 0.5f && AudioFootsteps != null)
            {
                AudioFootsteps.Play();
            }
        }
        ...
        {
            if (animationEvent.animatorClipInfo.weight > 0.5f && LandingAudio != null)
            {
                LandingAudio.Play();
            }
        }
